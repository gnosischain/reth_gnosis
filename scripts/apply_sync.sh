...
OUT_DIR=/Users/debjit/Drawer/gnosis/rlp/blocks

N=${1:-1}

START_BLOCK_NUMBER=26539985
...
function apply_block_file() {
  ...
  if [ $((CURRENT_COUNT % FINALIZATION_INTERVAL)) -eq 0 ]; then
    echo "Finalizing block $BLOCK_HASH"
